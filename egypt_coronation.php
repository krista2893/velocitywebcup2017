...
<html lang="en">
<head>
  <title>Velocity | Egypt Coronation</title>
...
.bgimg-1 {
  background-image: url("assets/_images/egypt/egypt_corr1.jpg");
  min-height: 100%;
}

.bgimg-2 {
  background-image: url("assets/_images/egypt/corr_2.jpg");
  min-height: 400px;
}

.bgimg-3 {
  background-image: url("assets/_images/egypt/god.jpg");
  min-height: 400px;
}
...
<body>
  ...
  <div class="caption">
    <span class="border">Feel like a Pharaoh for a day</span>
  </div>
</div>
...
<div style="color: #777;background-color:white;text-align:center;padding:20px 80px;text-align: justify;">
  ...
  <p>Guided by humanoids, you may learn every trick and treat of the wise Egyptians. Observe the Ancient Egypt in its original splendour with its replicated populace.</p>
...
<div style="position:relative;">
  <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
    <p>Can you imagine how it feels to be ruling over a mighty kingdom? Now you can...</p>

      <div class="row text-center">
        <video controls oop muted autoplay poster="assets/_images/roman_2.jpg" class="fullscreen_bg_video">        
            <source src="assets/coro.mp4" type="video/mp4">       
        </video>
      </div>
  </div>
</div>
...
<div style="position:relative;">
  <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
    <p>With all rites and rituals, you will get the first hand feel of the sacred coronation ceremony of a Pharaoh. It is even said that the Gods themselves pay witness to this event. One cannot get any luckier...</p>
  </div>
</div>
