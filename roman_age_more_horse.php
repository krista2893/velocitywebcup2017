...
<title>Velocity | Horse Riding Rome</title>
	<!-- meta data -->
    <meta charset="utf-8">
...
.bgimg-1 {
  background-image: url("assets/_images/roman/roman_4.jpg");
  min-height: 100%;
}

.bgimg-2 {
  background-image: url("assets/_images/roman/roman_11.JPG");
  min-height: 400px;
}

.bgimg-3 {
  background-image: url("assets/_images/roman/roman_new_bg.jpg");
  min-height: 400px;
}
...
<body>
  ...
  <div class="caption">
    <span class="border">See more of the Colosseum than ever before</span>
  </div>
</div>
...
<div style="color: #777;background-color:white;text-align:center;padding:20px 80px;text-align: justify;">
  ...
  <p>
    Feel your blood pulsing in your veins with this thrilling sports adventure aboard chariots
  </p>
</div>

<div class="bgimg-2">
  <div class="caption">
    <span class="border" style="background-color:transparent;font-size:25px;color: #f7f7f7;">The Colosseum</span>
  </div>
</div>
