...
<title>Velocity | Stone Age Trail</title>
  <!-- meta data -->
    <meta charset="utf-8">
...
.bgimg-1 {
  background-image: url("assets/_images/stoneage/fire.jpg");
  min-height: 100%;
}

.bgimg-2 {
  background-image: url("assets/_images/stoneage/hut1.jpg");
  min-height: 400px;
}

.bgimg-3 {
  background-image: url("assets/_images/stoneage/stone1.jpg");
  min-height: 400px;
}
...
<body>
  ...
  <div class="caption">
    ...
    Be careful of the dangers lurking around!!!</span>
  </div>
</div>
...
<div style="color: #777;background-color:white;text-align:center;padding:20px 80px;text-align: justify;">
  ...
  <p>
    Get to your shoes and tame the unexplored dense forests of the Stone Age
  </p>
...
<div style="position:relative;">
  <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
    <p>With a fellow humanoid caveman, you will get to follow an adventurous track full of surprises through the wild land, as a caveman.</p>
...
<div style="position:relative;">
  <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
    <p>Feel the hardship, live the hardship!</p>
  </div>
</div>
