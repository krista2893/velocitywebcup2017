...
<title>Velocity | Stone Age Hunting</title>
  <!-- meta data -->
    <meta charset="utf-8">
...
.bgimg-1 {
  background-image: url("assets/_images/stoneage/hunt.jpg");
  min-height: 100%;
}
...
.bgimg-3 {
  background-image: url("assets/_images/stoneage/hunt4.jpg");
  min-height: 400px;
}
...
<body>
  ...
  <div class="caption">
    <span class="border">Relive your basic instincts as mammals...</span>
  </div>
</div>
...
<div style="color: #777;background-color:white;text-align:center;padding:20px 80px;text-align: justify;">
  ...
  <p>Time to dirty your hands and guts to make a living!!</p>
...
<div style="position:relative;">
  <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
    <p>With the aid of humanoids, you will be able to participate in real-life hunting games of huge beasts like mammoths... with stone tools!!</p>
  ...
  <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
    <p><div class="row text-center">
        <video controls oop muted autoplay poster="assets/_images/roman_2.jpg" class="fullscreen_bg_video">        
            <source src="assets/hunt.mp4" type="video/mp4">       
        </video>
      </div></p>
  </div>
</div>
