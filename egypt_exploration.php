...
<html lang="en">
<head>
 <title>Velocity | Egypt Exploration</title>
...
.bgimg-1 {
  background-image: url("assets/_images/egypt/carousel_egypt.jpg");
  min-height: 100%;
}

.bgimg-2 {
  background-image: url("assets/_images/egypt/visit2.jpg");
  min-height: 400px;
}

.bgimg-3 {
  background-image: url("assets/_images/egypt/egypt_11.jpg");
  min-height: 400px;
}
...
<body>
  ...
  <div class="caption">
    <span class="border">Be the Christopher Columbus for Ancient Egypt</span>
  </div>
</div>
...
<div style="color: #777;background-color:white;text-align:center;padding:20px 80px;text-align: justify;">
  ...
  <p>Guided by humanoids, you may learn every trick and treat of the wise Egyptians. Understand their doctrines and science. Observe the Ancient Egypt in its original splendour with its replicated populace.</p>
...
<div style="position:relative;">
  <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
    <p>Let the explorer in you discover the narrow alleys of the Pyramids</p>
