...
<title>Velocity | Stone Age Painting</title>
  <!-- meta data -->
    <meta charset="utf-8">
...
.bgimg-1 {
  background-image: url("assets/_images/stoneage/painting1.jpg");
  min-height: 100%;
}

.bgimg-2 {
  background-image: url("assets/_images/stoneage/painting2.jpg");
  min-height: 400px;
}

.bgimg-3 {
  background-image: url("assets/_images/stoneage/cave_1.jpg");
  min-height: 400px;
}
...
<body>
  ...
  <div class="caption">
    <span class="border">For the art lovers, a new form to be discovered....</span>
  </div>
</div>
...
<div style="color: #777;background-color:white;text-align:center;padding:20px 80px;text-align: justify;">
  ...
  <p>Get to your stones and caves Picassos!!!</p>
...
<div style="position:relative;">
  <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
    <p>Under the guidance of our expert caveman, you can freely leave your own creative imprint on a cave for your future generations to remember...</p>
