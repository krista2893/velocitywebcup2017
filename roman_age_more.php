...
<html lang="en">
<head>
      <title>Velocity | Roman Gladiators</title>
...
.bgimg-1 {
  background-image: url("assets/_images/roman/roman_5.jpg");
  min-height: 100%;
}

.bgimg-2 {
  background-image: url("assets/_images/roman/roman_bg.jpg");
  min-height: 400px;
}

.bgimg-3 {
  background-image: url("assets/_images/roman/6.jpg");
  min-height: 400px;
}
...
<body>
  ...
  <div class="caption">
    <span class="border">Assist unique fights between android gladiators</span>
  </div>
</div>
...
<div style="color: #777;background-color:white;text-align:center;padding:20px 80px;text-align: justify;">
  ...
  <p>A gladiator was a professional fighter who specialised with particular weapons and fought before the public in large purpose-built arenas throughout the Roman Empire from 105 BCE to 404 CE</p>
...
<div style="position:relative;">
  <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
    <p>Get the opportunity to fight like them or watch them fight.</p>
...
<div style="position:relative;">
  <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
    <p>
<div class="row text-center">
        <video controls oop muted autoplay poster="assets/_images/roman_2.jpg" class="fullscreen_bg_video" preload="none">        
            <source src="assets/glad.mp4" type="video/mp4">       
        </video>
      </div>
    </p>
  </div>
