...
<title>Velocity | Nile River</title>
  <!-- meta data -->
    <meta charset="utf-8">
...
.bgimg-1 {
  background-image: url("assets/_images/egypt/egypt_1.jpg");
  min-height: 100%;
}

.bgimg-2 {
  background-image: url("assets/_images/egypt/egypt_2.jpg");
  min-height: 400px;
}

.bgimg-3 {
  background-image: url("assets/_images/egypt/egypt_3.jpg");
  min-height: 400px;
}
...
<div style="color: #777;background-color:white;text-align:center;padding:20px 80px;text-align: justify;">
  ...
  <p>Have a peaceful eye-candy ride down the Nile, along the luscious green valley.</p>
...
<div style="position:relative;">
  <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
    <p>The Nile river crosses all the length of the huge land of Egypt. An opportunity to enjoy the view of the daily events of the people from a Khufu ship is the best way to spend a day in serenity</p>
...
<div style="position:relative;">
  <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
    <p>This river once was home to ferocious crocodiles which were once worshipped by the people</p>
  </div>
</div>
