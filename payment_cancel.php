...
<html lang="en">
<head>
    <title>Velocity | Payment Cancel</title>
...
<body>
   ...
   <div class="bg1">
        ...
        <div class="caption_home">
            <span class="border">Your payment has been unsuccessful. <br />
                <a href="home.php">Go back to homepage <i class="fa fa-home" aria-hidden="true"></i> </a>
            </span><br>
